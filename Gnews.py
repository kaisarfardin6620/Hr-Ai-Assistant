...
# RSS feed sources for each HR topic, with explicit source names
import feedparser

RSS_FEEDS = {
    "hr strategy and leadership": [
        {"source": "HR Executive", "url": "https://hrexecutive.com/feed/"},
        {"source": "Harvard Business Review - Leadership", "url": "https://hbr.org/feed/section/leadership"},
        {"source": "HR Dive - Strategy", "url": "https://www.hrdive.com/rss/strategy/"},
        {"source": "SHRM - Executive HR", "url": "https://www.shrm.org/rss/feed.aspx?category=executive"},
        {"source": "HR Grapevine", "url": "https://www.hrgrapevine.com/rss"}
    ],
    "workforce compliance and regulation": [
        {"source": "EEOC Newsroom", "url": "https://www.eeoc.gov/newsroom/rss.xml"},
        {"source": "HR Dive - Compliance", "url": "https://www.hrdive.com/rss/compliance/"},
        {"source": "SHRM - Legal Issues", "url": "https://www.shrm.org/rss/feed.aspx?category=legal"},
        {"source": "Law360 - Employment", "url": "https://www.law360.com/employment-authority/rss"}
    ],
    "talent acquisition and labor trends": [
        {"source": "ERE Media", "url": "https://www.eremedia.com/rss"},
        {"source": "HR Dive - Talent Acquisition", "url": "https://www.hrdive.com/rss/talent-acquisition/"},
        {"source": "Workology - Recruiting", "url": "https://workology.com/category/recruiting/feed/"},
        {"source": "Undercover Recruiter", "url": "https://theundercoverrecruiter.com/feed/"}
    ],
    "compensation, benefits and rewards": [
        {"source": "BenefitsPRO", "url": "https://www.benefitspro.com/rss/"},
        {"source": "SHRM - Compensation & Benefits", "url": "https://www.shrm.org/rss/feed.aspx?category=compensation"},
        {"source": "HR Dive - Benefits", "url": "https://www.hrdive.com/rss/benefits/"}
    ],
    "people development and culture": [
        {"source": "Chief Learning Officer", "url": "https://www.chieflearningofficer.com/feed/"},
        {"source": "HR Bartender", "url": "https://www.hrbartender.com/feed/"},
        {"source": "Workology - HR Development", "url": "https://workology.com/category/hr/feed/"}
    ]
}

@retry(stop=stop_after_attempt(3), wait=wait_random_exponential(min=1, max=5))
def fetch_news(topic: str, max_results=5) -> list:
    """Fetches news articles from multiple RSS feeds for a given topic, using explicit source names."""
...
if __name__ == "__main__":
>>>>>>> abd46b19748f4b7d61f1d452bf6e6c4999dcae7f
    main()